...
import 'package:NicarAdmin/screens/wrapper/wrapper.dart';
import 'package:NicarAdmin/theme/theme.dart';

void main() {
  runApp(const NicarAdmin());
}

class NicarAdmin extends StatelessWidget {
  const NicarAdmin({Key? key}) : super(key: key);
