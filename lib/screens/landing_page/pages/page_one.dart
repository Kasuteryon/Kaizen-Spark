...
class PageOne extends StatelessWidget {
  ...
  static const List<String> _numberOfPatients = ["5", "50"];
  static const List<String> _typeOfDose = ["Modelos", "Usuarios"];
