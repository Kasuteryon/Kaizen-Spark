...
abstract class AppThemeColours {
  //! MAIN COLOUR
  static Color primaryColour = const Color(0xFF0096FF);
  static Color secondaryColour = const Color(0xFF004AAD);
  ...
  static Color focusedTextFormFieldColour = const Color(0xFF00BF63);

  //! ELEVATED BUTTON AND CONTAINERS
  static Color elevatedButtonBackgroundColour = const Color(0xFFff5757);
